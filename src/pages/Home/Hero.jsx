        ...
        <section className="bg-base-100 py-10 md:py-20 relative overflow-hidden">
            <div className="max-w-[1326px] mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 gap-10 md:gap-0">
                ...
                <div className="flex-1 w-full max-w-xl text-center md:text-left">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-primary mb-6">
                        The <motion.span
                            animate={
                                {
                    ...
                    <p className="text-accent text-base sm:text-lg mb-8 max-w-md mx-auto md:mx-0">
                    ...
                    {/* Search Bar */}
                    <form className="flex flex-col sm:flex-row items-stretch sm:items-center bg-secondary/5 rounded-xl shadow-md p-3 border border-secondary/10 sm:p-4 gap-2 sm:gap-4 w-full max-w-2xl mb-6 mx-auto md:mx-0">
                        <div className="flex items-center gap-2 flex-1 min-w-0">
                            ...
                            <select className="bg-transparent outline-none w-full text-accent text-sm">
                        ...
                        <input type="text" className="flex-1 min-w-0 bg-transparent outline-none px-2 py-2 text-accent text-sm" placeholder="Your keyword..." />
                    ...
                    <div className="text-gray-600 text-xs sm:text-sm font-medium flex flex-wrap justify-center md:justify-start gap-x-2 gap-y-1">
                        <span className="font-semibold text-accent">Popular Searches:</span>
                ...
                {/* Right: Images */}
                <div className="flex-1 w-full flex flex-col items-center gap-6 mt-10 md:mt-0 relative">
                    <div className="relative flex flex-col w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
                        <motion.img
                            animate={{ y: [0, 30, 0] }}
                            transition={{ duration: 5, repeat: Infinity }}
                        ...
                        <motion.img
                            ...
                            className="w-full sm:w-1/2 md:w-1/2 rounded-t-3xl border-s-8 border-b-8 border-secondary object-cover object-center shadow-lg absolute -bottom-10 right-0 aspect-video" />
                    </div>
                </div>
            </div>

        ...
        <section className="bg-[#f6f9fc] py-10 md:py-20 relative overflow-hidden">
            <div className="max-w-[1326px] mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 gap-10 md:gap-0">
                ...
                <div className="flex-1 w-full max-w-xl text-center md:text-left">
                    ...
                    {/* Search Bar */}
                    <form className="flex flex-col sm:flex-row items-stretch sm:items-center bg-white rounded-xl shadow-lg p-3 sm:p-4 gap-2 sm:gap-4 w-full max-w-2xl mb-6 mx-auto md:mx-0">
                        ...
                        <button type="submit" className="bg-secondary hover:bg-blue-700 text-white font-semibold px-4 sm:px-6 py-2 rounded-lg shadow transition-all w-full sm:w-auto mt-2 sm:mt-0">

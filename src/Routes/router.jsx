...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://career-loop-server.vercel.app/applications/job/${params.job_id}`)
            },
            
            {
                path: '/job-details/:id',
                loader: ({params}) => fetch(`https://career-loop-server.vercel.app/jobs/${params.id}`),
